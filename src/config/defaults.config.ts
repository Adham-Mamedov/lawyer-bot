...
export const TELEGRAM_MESSAGES = {
  ...
  LIMIT_REACHED: `К сожалению, вы достигли лимита. Этот бот бесплатный, поэтому вы можете использовать лишь ${TOKENS_PER_DAY_LIMIT} токенов (5-6 вопросов) в день. Спасибо за понимание! Возвращайтесь завтра)`,
